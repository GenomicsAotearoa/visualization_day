...
We can now start to focus on the visualisation aspects: control plot themes such as labels, titles, spacing. We can explore geoms, and variations on geoms, to determine the best way to present the data. Finally, we can add additional geoms or mappings to display more data. 
...
We can now trial different geoms to determine which type suits our visualisation needs.

#### **Exercise:** use "groupCounts +" and your choice of a geom function to plot the data with the new theme. 

Test multiple different geoms to experience how easily we can test different visualisations. 
