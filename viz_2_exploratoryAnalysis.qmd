---
title: Visualisation for ourselves - Exploratory Analysis
toc: true
---
...
The aims for this section are to give you the opportunity to practice some of the most important code used in visualizations and to force you to think about visualisation: what types of figures work well for certain data, how to display the information you want to convey. 
...
Because stacked area plots can be misleading, they are not recommended as a type of visualisation.
