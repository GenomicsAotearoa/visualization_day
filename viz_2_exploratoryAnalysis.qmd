...
...it can be misleading, because a violin based on 68 observations looks just as "confident" as one based on 152. We can address this with `scale = "count"`, which scales violin width proportionally to sample size:
