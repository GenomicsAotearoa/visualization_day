...
[The R graph Gallery](https://r-graph-gallery.com/ggplot2-package.html) has a section on ggplot and it highlights some of the exciting features: custom fonts, pre-built themes, interactive plots - there's a lot going on. Note that many of the graphs are built using ggplot, but not all.  
...
[Awesome ggplot2 on GitHub](https://github.com/erikgahner/awesome-ggplot2)
